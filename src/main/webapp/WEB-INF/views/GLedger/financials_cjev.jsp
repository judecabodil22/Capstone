	...
	<!-- /form elements scripts -->
	 ...
	 $(document).ready(function() {
	        ...
	        $("#add_row2").click(function() {
	            $('#addr' + i).html("<td><select id='e1" + i + "' class="form-control select2"><option value="1">sample</option></select></td>\<td><select id='e1" + i + "' class="form-control select2"><optgroup label="Assets"><option value="1">Cash</option><option value="2">Accounts Receivable</option><option value="3">Notes Receivable</option></optgroup><optgroup label="Liabilities"><option value="1">Accounts Payable</option><option value="1">Notes Payable</option></optgroup></select></td><td><input type='text" + i + "' class="form-control" maxlength="19"/></td><td><select id='e1" + i + "' class="form-control select2"><optgroup label="Assets"><option value="1">Cash</option><option value="2">Accounts Receivable</option><option value="3">Notes Receivable</option></optgroup><optgroup label="Liabilities"><option value="1">Accounts Payable</option><option value="1">Notes Payable</option></optgroup></select></td><td><input type='text" + i + "' class="form-control" maxlength="19"/></td><td><input type='text" + i + "' class="form-control" maxlength="500"/></td>");
