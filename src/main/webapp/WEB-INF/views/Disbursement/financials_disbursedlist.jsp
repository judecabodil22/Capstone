	...
	<div class="col-md-12">
		<div class="portlet box primary">
			...
			<div class="portlet-title">
				<div class="caption">
					<i class="livicon" data-name="sort-up" data-size="16" data-loop="true" data-c="#fff" data-hc="white"></i>
					Disbursement List
				</div>
			</div>
			...
			<div class="portlet-body">
				...
				<div class="table-scrollable">
					<table id="ColTable" class="table table-striped table-bordered table-advance table-hover">
						<thead>
							<tr>
						...
						<tbody>
						<c:forEach var="list" items="${disb_list}" varStatus="vs">
							<tr>
								<td>
									<fmt:formatDate value="${list.dv_date}" type="date" />
								</td>
								<td>${list.dv_no}</td>
								<td>${list.dv_payee}</td>
								<td>
									<fmt:formatNumber value="${list.dv_amount}" type="currency" />
								</td>
								<td>
									<!-- view  -->
									<a type="button" class="btn info" data-toggle="modal" data-target="#disb${vs.index}" id="viewDetailButton${vs.index}">
									...
									<!-- Modal -->
									<div class="modal fade" id="disb${vs.index}" role="dialog">
											...
											<div class="modal-content">
												<div class="modal-header">
													<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
														<h4 class="modal-title">Disbursement Voucher Information</h4>
												</div>
													...
													<div class="table-scrollable">
														<table id="tbl1" class="table table-bordered table-striped" style="clear:both">
															<tbody>
																<tr>
																	<td>Date</td>
																	<td><fmt:formatDate value="${list.dv_date}" type="date" /></td>
																</tr>   
																<tr>
																	<td>Code</td>
																	<td>${list.dv_no}</td>
																...
																<tr>
																	<td>Address</td>
																	<td>${list.dv_address}</td>
																</tr>
																<tr>
																	<td>Amount</td>
																	<td><fmt:formatNumber value="${list.dv_amount}" type="currency" /></td>
																</tr>
...
function searchFunction() {
	...
	table = document.getElementById("ColTable");
